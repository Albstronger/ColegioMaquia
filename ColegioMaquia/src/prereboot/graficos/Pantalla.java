...
import prereboot.entes.criaturas.Jugador;
import prereboot.mapa.cuadro.Cuadro;
...
//				pixeles[posicionX + posicionY * ancho] = jugador.getSprite().pixeles[x
//						+ y * jugador.getSprite().getLado()];
